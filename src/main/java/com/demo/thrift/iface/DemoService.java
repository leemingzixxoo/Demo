...
public class DemoService {
  ...
  public interface Iface {
    ...
    public String sayHello(HelloMan man) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void sayHello(HelloMan man, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_sayHello(HelloMan man) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void sayHello(HelloMan man, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      sayHello_call method_call = new sayHello_call(man, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class sayHello_call extends org.apache.thrift.async.TAsyncMethodCall {
      private HelloMan man;
      public sayHello_call(HelloMan man, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class sayHello<I extends Iface> extends org.apache.thrift.ProcessFunction<I, sayHello_args> {
      ...
      public sayHello_result getResult(I iface, sayHello_args args) throws org.apache.thrift.TException {
        sayHello_result result = new sayHello_result();
        result.success = iface.sayHello(args.man);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class sayHello<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, sayHello_args, String> {
      ...
      public void start(I iface, sayHello_args args, org.apache.thrift.async.AsyncMethodCallback<String> resultHandler) throws TException {
        iface.sayHello(args.man,resultHandler);
      }
    }
  ...
  public static class sayHello_args implements org.apache.thrift.TBase<sayHello_args, sayHello_args._Fields>, java.io.Serializable, Cloneable, Comparable<sayHello_args>   {
    ...
    private static final org.apache.thrift.protocol.TField MAN_FIELD_DESC = new org.apache.thrift.protocol.TField("man", org.apache.thrift.protocol.TType.STRUCT, (short)1);
    ...
    static {
      ...
      tmpMap.put(_Fields.MAN, new org.apache.thrift.meta_data.FieldMetaData("man", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, HelloMan.class)));
    ...
    public sayHello_args(sayHello_args other) {
      if (other.isSetMan()) {
        this.man = new HelloMan(other.man);
      }
    }
    ...
    public HelloMan getMan() {
      return this.man;
    }

    public sayHello_args setMan(HelloMan man) {
      this.man = man;
      return this;
    }
    ...
    /** Returns true if field man is set (has been assigned a value) and false otherwise */
    public boolean isSetMan() {
      return this.man != null;
    }

    public void setManIsSet(boolean value) {
      if (!value) {
        this.man = null;
      }
    }
    ...
    public boolean equals(sayHello_args that) {
      ...
      boolean this_present_man = true && this.isSetMan();
      boolean that_present_man = true && that.isSetMan();
      if (this_present_man || that_present_man) {
        if (!(this_present_man && that_present_man))
          return false;
    ...
    public int hashCode() {
      ...
      boolean present_man = true && (isSetMan());
      list.add(present_man);
      if (present_man)
        list.add(man);
    ...
    public int compareTo(sayHello_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetMan()).compareTo(other.isSetMan());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetMan()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.man, other.man);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    private static class sayHello_argsStandardScheme extends StandardScheme<sayHello_args> {
          ...
          switch (schemeField.id) {
            case 1: // MAN
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.man = new HelloMan();
                struct.man.read(iprot);
                struct.setManIsSet(true);
              } else { 
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, sayHello_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.man != null) {
          oprot.writeFieldBegin(MAN_FIELD_DESC);
          struct.man.write(oprot);
          oprot.writeFieldEnd();
        }
